    ...
    <section className="flex h-full flex-col items-center">
      <div className="w-full space-y-6">
        ...
        <div className="relative w-full overflow-visible">
          ...
          <div className="relative rounded-lg text-xs md:mt-10 md:px-2 md:text-base">
            <p className="mt-5 leading-relaxed">
              Led a team of five, authored the Triple Z Coffee Shop capstone
              project, and published it under IPOPHL copyright (Certificate).
              The system included a booking calendar, package selection, secure
              PayMongo payments, menu image hosting through Google Cloud
